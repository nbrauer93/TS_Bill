...
def read_file(infile):
    ...
    a = id.variables['SpecificAttenuation']
    wa = id.variables['wSpecificAttenuation']
    ...
    avalues = np.zeros(x['n']*y['n']*z['n'])*np.nan
    wavalues = np.zeros(x['n']*y['n']*z['n'])
    values[:] = float('nan')
    ...
    avalues = avalues.reshape((z['n'], y['n'] ,x['n']))
    wavalues = wavalues.reshape((z['n'], y['n'] ,x['n']))
    ...
    a = {'values'     : avalues,              \
			 'long_name'  : str(a.long_name),  \
			 'units'      : str(a.units),      \
			 'missing'    : float('nan'),        \
			 'wvalues'    : wavalues,             \
			 'wlong_name' : str(wa.long_name), \
			 'wunits'     : str(wa.units),     \
			 'wmissing'   : wa.missing_value,  \
			 'n'          : values.size}
